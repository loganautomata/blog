	...
	<div class="focusinfo">
		...
		<div class="header-info">
            ...
            <div class="top-social_v2">
                ...
                <li><a href="<?php echo akina_option('github', ''); ?>" target="_blank" class="social-github" title="github"><img src="https://wp.oss.logan.ren/sakura/images/github-icon.png"/></a></li>
                <?php } ?>	
