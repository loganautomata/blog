		...
		<div class="site-info" theme-info="Sakura v<?php echo SAKURA_VERSION; ?>">
			...
			<p style="font-family: 'Ubuntu', sans-serif;">
					<span style="color: #b9b9b9;">
						&copy 2019-<?php echo date('Y')?> <img class="iconfont rotating" style="color: #ffc0cb;display:inline-block;width:16px;height:16px" src="https://cdn.jsdelivr.net/gh/loganautomata/cdn@master/blog/images/logo-blog.png"></img> <a href="https://loganren.xyz/" target="_blank" style="color: #b9b9b9;">Loganの小站</a>
					</span>
				</p>
			</div>
		</div><!-- .site-info -->
